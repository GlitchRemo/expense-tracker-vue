...
export default {
  ...
  data() {
    return {
      expenses: [
        { date: '2025-04-18', category: 'Groceries', amount: 1200 },
        { date: '2025-04-19', category: 'Transport', amount: 400 },
        { date: '2025-04-20', category: 'Utilities', amount: 800 },
        { date: '2025-04-21', category: 'Dining', amount: 500 },
      ],
      categoryColors: {
    ...
    <table class="table-auto text-left w-full mt-4 border-collapse border border-gray-300">
      <thead>
        <tr class="bg-gray-200">
          ...
          <th class="border-b border-gray-300 px-4 py-2 min-w-[125px]">Category</th>
      ...
      <tbody>
        <tr v-for="expense in expenses" :key="expense.id">
          ...
          <td class="border-b border-gray-300 px-4 py-2">{{ expense.category }}</td>
